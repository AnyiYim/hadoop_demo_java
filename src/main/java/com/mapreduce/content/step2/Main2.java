package com.mapreduce.content.step2;
...
public class Main2 {
    private static String inPath = "/content/step2_input";
    private static String outPath = "/content/step2_output";
